...
api.userDefaults =
  habits: [
    {text: t('defaultHabit1Text'), notes: t('defaultHabit1Notes'), value: 0, up: true, down: false, attribute: 'str'}
    {text: t('defaultHabit2Text'), notes: t('defaultHabit2Notes'), value: 0, up: false, down: true, attribute: 'str'}
    {text: t('defaultHabit3Text'), notes: t('defaultHabit3Notes'), value: 0, up: true, down: true, attribute: 'str'}
  ]
...
#    {text: t('defaultTodo5Text'), notes: t('defaultTodoNotes'), completed: false, attribute: 'per' }
  ...
  rewards: [
#   {text: t('defaultReward1Text'), notes: t('defaultReward1Notes'), value: 20 }
#   {text: t('defaultReward2Text'), notes: t('defaultReward2Notes'), value: 10 }
  ]
